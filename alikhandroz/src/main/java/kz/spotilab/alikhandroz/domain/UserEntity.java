...
public class UserEntity extends AbstractAuditingEntity<Long> {
    ...
    private SubscribtionEnum subscription = SubscribtionEnum.FREE;
    ...
    public SubscribtionEnum getSubscription() {
        return subscription;
    }

    public void setSubscription(SubscribtionEnum subscription) {
